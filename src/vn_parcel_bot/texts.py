...
LIST_ITEM = "{index}. <b>{title}</b> · {carrier}{meta}"
# Box-drawing branches, not leading spaces: Telegram sets a proportional font, where
# an indent of spaces is too thin to read as an indent at all.
LIST_BRANCH = "\n├ {line}"
LIST_BRANCH_LAST = "\n└ {line}"
